<?php
 ...
 // Registra no banco de dados 'equipetemp':--------------------------------------
  $sql="INSERT INTO `nanotec`.`equipetemp` (`nome_da_equipe`, `cnpj_equipe`, `numero_integrantes`, `endereco_equipe`, `telefone_equipe`, `email_equipe`,
     `senha_equipe`, `chave_equipe`)
...
// Cria uma entrada na tabela servicos temp: ------------------------------
    ...
    header("Location: registrandolhe.php");
